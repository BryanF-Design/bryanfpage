...
const en: Dictionary = {
  ...
  experience: {
    ...
    preparingAria: "Preparing the experience",
    readyAria: "Experience ready",
    prepare: "prepare",
    start: "start",
    loaderLine: "Design, code, and motion standing by.",
    aligning: "Aligning the interface",
    routeReady: "Route ready",
    skip: "Skip intro",
    phaseDesign: "Design",
    phaseDevelopment: "Development",
    phaseLaunch: "Launch",
    modelStudy: "A personal obsession, rendered in 3D",
    ...
    civicAria: "Interactive 3D model of a 2023 Honda Civic Type R",
    statsAria: "Studio facts",
    statsRecord: "Verified studio record",
  },
  trust: {
    years: "years",
  ...
  world: {
    ...
    locations: {
      ...
      spain: "Spain",
      france: "France",
      japan: "Japan · cultural connection",
    },
  },
  clients: {
