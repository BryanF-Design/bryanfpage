...
const pt: Dictionary = {
  ...
  experience: {
    ...
    preparingAria: "Preparando a experiência",
    readyAria: "Experiência pronta",
    prepare: "preparar",
    start: "partir",
    loaderLine: "Design, código e movimento a postos.",
    aligning: "Alinhando a interface",
    routeReady: "Rota pronta",
    skip: "Pular entrada",
    phaseDesign: "Design",
    phaseDevelopment: "Desenvolvimento",
    phaseLaunch: "Lançamento",
    modelStudy: "Uma obsessão pessoal, levada ao 3D",
    modelLoading: "Carregando modelo 3D",
    activateModel: "Ativar modelo 3D",
    lightweightView: "Visualização leve ativa",
    dragRotate: "Arraste para girar",
    tapBoost: "Toque para acelerar",
    driving: "condução",
    precision: "Precisão",
    systemOnline: "Sistema pronto",
    civicAria: "Modelo 3D interativo de um Honda Civic Type R 2023",
    statsAria: "Dados do estúdio",
    statsRecord: "Dados reais do estúdio",
  },
  trust: {
    years: "anos",
