...
/**
 * Dotted world map with animated arcs.
 * Adapted for BryanF Design: dark-only theme, brand-green lines,
 * no next-themes dependency, plain <img> for the data-URI background.
 */
export function WorldMap({
  ...
  return (
    <div className="relative w-full overflow-hidden rounded-lg font-sans aspect-[2/1] md:aspect-[2.5/1] lg:aspect-[2/1]">
                  ...
                  >
                    ...
                    >
                      <div className="flex h-full items-center justify-center">
                        <span className="rounded-md border border-primary/40 bg-background/90 px-2 py-0.5 text-sm font-medium text-foreground shadow-sm">
                          {dot.start.label}
                        </span>
                      </div>
                    </foreignObject>
