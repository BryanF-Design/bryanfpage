const logos = [
  ...
  { src: "/img/clients/herman-miller.svg", alt: "Herman Miller" },
        ...
        <div className="flex w-max animate-marquee items-center gap-16 pr-16">
          {[...logos, ...logos].map((logo, i) => (
            ...
            <img
              ...
              src={logo.src}
              alt={logo.alt}
              className="h-7 w-auto shrink-0 opacity-60 transition-opacity duration-300 hover:opacity-100 md:h-8 [filter:brightness(0)_invert(1)]"
              loading="lazy"
            />
          ))}
        </div>
